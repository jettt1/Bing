...
from threading import Event  # Import Event for synchronization
...
def run_gui(player, greeting_done_event):
    #Creating a tkinter instance and connecting it to the player
    root = tk.Tk()
    app_gui = AppGUI(root)
    ...
    #Running the GUI greeting screen 
